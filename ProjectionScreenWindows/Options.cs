...
namespace ProjectionScreenWindows
{
    ...
    public class Options : OptionInterface
    {
        ...
        public Options()
        {
            ...
            framerate = config.Bind("framerate", defaultValue: 40, new ConfigurableInfo("Setpoint for maximum capture framerate. Currently cannot reach more then 40 because the code is hooked at the tickrate.", new ConfigAcceptableRange<int>(1, 99), "", "Framerate setpoint"));
